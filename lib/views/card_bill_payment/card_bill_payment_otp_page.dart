...
class CardBillPaymentOtpPage extends StatefulWidget{
  final TransactionViewModel? _transaction;
  final TransactionAmountDescriptionWidget header;
  CardBillPaymentOtpPage(this._transaction,this.header);

  @override
  _CardBillPaymentOtpPageState createState() => _CardBillPaymentOtpPageState(_transaction,header);
}

class _CardBillPaymentOtpPageState extends State<CardBillPaymentOtpPage>
    with
        BasePageMixin<CardBillPaymentOtpPage, CardBillPaymentPresenter>,
        AutomaticKeepAliveClientMixin<CardBillPaymentOtpPage>
    implements CardBillPaymentIMvpView{
  TransactionViewModel? _transaction;
  TransactionAmountDescriptionWidget header;
  _CardBillPaymentOtpPageState(this._transaction,this.header);
