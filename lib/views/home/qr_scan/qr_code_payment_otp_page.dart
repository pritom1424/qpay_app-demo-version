...
class QrCodePaymentOtpPage extends StatefulWidget {
  ...
  @override
  _QrCodePaymentOtpPageState createState() =>
      _QrCodePaymentOtpPageState(_transaction, header);
}
...
class _QrCodePaymentOtpPageState extends State<QrCodePaymentOtpPage>
  ...
  static const borderColor = Color.fromRGBO(0, 0, 0, 1); //C
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: MyAppBar(centerTitle: AppLocalizations.of(context)!.qrPayment),
