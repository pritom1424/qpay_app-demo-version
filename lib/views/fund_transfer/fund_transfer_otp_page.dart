...
class FundTransferOtpPage extends StatefulWidget {
  final TransactionViewModel _transaction;
  final TransactionAmountDescriptionWidget header;
  FundTransferOtpPage(this._transaction, this.header);

  @override
  _FundTransferOtpPageState createState() =>
      _FundTransferOtpPageState(_transaction, header);
}

class _FundTransferOtpPageState extends State<FundTransferOtpPage>
    with
        BasePageMixin<FundTransferOtpPage, FundTransferPresenter>,
        AutomaticKeepAliveClientMixin<FundTransferOtpPage>
    implements FundTransferIMvpView {
  TransactionViewModel _transaction;
  TransactionAmountDescriptionWidget header;
  _FundTransferOtpPageState(this._transaction, this.header);
