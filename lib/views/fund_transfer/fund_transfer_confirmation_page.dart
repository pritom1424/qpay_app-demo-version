...
import 'fund_transfer_iview.dart';
import 'fund_transfer_otp_page.dart';
import 'fund_transfer_presenter.dart';

class FundTransferConfirmationPage extends StatefulWidget {
  final double amount;
  ...
  @override
  _FundTransferConfirmationPageState createState() =>
      _FundTransferConfirmationPageState(
...
class _FundTransferConfirmationPageState
    extends State<FundTransferConfirmationPage>
    with
        BasePageMixin<FundTransferConfirmationPage, FundTransferPresenter>,
        AutomaticKeepAliveClientMixin<FundTransferConfirmationPage>
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: MyAppBar(
          centerTitle: AppLocalizations.of(context)!.fundTransfer,
        ),
        body: MyScrollView(
          children: _buildBody(),
        ),
              ...
              child: Column(
                children: [
                  ...
                  MyButton(
                    ...
                    onPressed: _initiate,
                    text: _selectedDebitAccount.id == -100
  ...
  void totalTransactionAmount() {
    if (_feeAmount.toString() != null &&
        _amount.toString() != null &&
        _vatAmount.toString() != null) {
  ...
  void _initiate() async {
    ...
    final bool accountType =
        (_selectedDebitAccount.ownershipType == 'Personal' ? true : false);
    final String purpose = _purpose;
    final String cvv = _cvv;
    var response = await presenter.fundTransfer(
    ...
    var future = showModalBottomSheet(
      ...
      builder: (_) => TransactionCompletedPage(
        ...
        TransactionAccountSelector('From', _selectedDebitAccount,
            isEnabled: false),
        TransactionAccountSelector('To  ', _selectedCreditAccount,
            isEnabled: false),
        transaction,
      ),
    );
  ...
  @override
  FundTransferPresenter createPresenter() => FundTransferPresenter();
