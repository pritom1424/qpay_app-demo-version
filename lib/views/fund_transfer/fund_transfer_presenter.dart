...
class FundTransferPresenter extends BasePagePresenter<FundTransferIMvpView> {
  ...
  Future<TransactionViewModel?> fundTransfer(double amount, int debitAccountId,
      int creditAccountId,bool ownerShipType,String purpose,String cvv) async {
  ...
  Future<List<TransactionFeeViewModel>?> transactionFeeCalculate(String id, double amount,{String vendor='',bool isAnonymous=false}) async{
    final Map<String, dynamic> queryParams = {
      'PolicyId':id,
      'Amount': amount,
      'Vendor': vendor,
      'IsAnonymousCard': isAnonymous,
    };
